...
AGILENT_34461A = {'vendor':0x0957, 'product':0x1a07}
...
class instrument(object):
    ...
    def usb_info_string(self):
        ...
        """
        manufacturer=usb.util.get_string(self.usb_dev, 255, self.usb_dev.iManufacturer)
        product=usb.util.get_string(self.usb_dev, 255, self.usb_dev.iProduct)
        serial=usb.util.get_string(self.usb_dev, 255, self.usb_dev.iSerialNumber)
